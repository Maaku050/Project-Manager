...
import { AssignedUser, Project, StarsPoints, Task } from "@/_types";
...
export const ProjectProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    // --- Projects ---
    const unsubProject = onSnapshot(query(collection(db, "project")), (snapshot) => {
    ...
    // --- Assigned Users ---
    const unsubAssignedUsers = onSnapshot(collection(db, "assignedUser"), (snapshot) => {
    ...
    // --- Stars Points ---
    const unsubStarsPoints = onSnapshot(collection(db, "starsPoints"), (snapshot) => {
