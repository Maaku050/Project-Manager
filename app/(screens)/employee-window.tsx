...
export default function EmployeeWindow() {
  ...
  const onProgressProject = currentUserProjects.filter((p) => p.status === "Pending" || p.id === "");
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#000000ff", paddingTop: 12, paddingLeft: 32, paddingRight: 32, paddingBottom: 40}}>

        <VStack style={{
          borderWidth: 0,
          borderColor: "red", 
          padding: 12, gap: isLargeScreen ? 16 : isMediumScreen ? 12 : 8
          }}>

          <Box style={{height: 70, width: "100%", backgroundColor: "#3f3f3fff", justifyContent: "center"}}>
            ...
            <HStack style={{
              ...
              gap: isLargeScreen ? 16 : isMediumScreen ? 16 : 12,
                ...
                {/* profile area  */}
              <VStack style={{flex: 1, borderWidth: 1, borderColor: "gray", justifyContent: "center", alignItems: "center", height: "100%"}}>

                {/* PROFILE OF USER CLICKED HERE:  */}
                  <Avatar size="2xl" style={{backgroundColor: "#CDCCCC"}}>
                  <AvatarFallbackText style={{color: "#000000"}}>{currentUser?.firstName}</AvatarFallbackText>
                  </Avatar>
                  <Heading style={{
                    fontSize: 20, 
                    fontFamily: "roboto, arial", 
                    color: "#CDCCCC"
                    }}>{currentUser?.nickName}</Heading>
                  <Text style={{
                    color:"#CDCCCC", 
                    fontWeight: "semibold", 
                ...
                {/* user info. */}
              <ScrollView style={{flex: 1, borderWidth: 2, borderColor: "#727070ff", height: "100%"}}>
                <Text style={{
                  ...
                  <HStack style={{justifyContent: "space-between", alignItems: "center", flex: 1, borderWidth: 0}}>
                    <Text style={{fontFamily: "roboto, arial", fontWeight: "bold", color: "#ffffff"}}>In Progress</Text>
                    <Divider style={{borderWidth: 2, flex: 1, marginLeft: 12, borderColor: "#1f1f1f"}}></Divider>
                  </HStack>
                    ...
                    {onProgressProject.map((t) => (
                      ...
                      style={{
                        ...
                        flexWrap: "wrap"
                          ...
                          <Pressable style={{borderWidth: 1, width: "100%"}}>
                            <Card
                            size="lg"
                            ...
                            style={{
                              ...
                              <HStack style={styles.AvatarMargin}>
                                {profiles.filter((p) => assignedUser.some((a) => a.projectID === t.id && a.uid === p.uid)).map((t) => {
                                  return (
                                    <Avatar size="sm" style={{backgroundColor: "#CDCCCC", marginLeft: 4}}>
                                      <AvatarFallbackText size="sm" key={t.id} style={{color: "#000000", fontWeight: "bold", fontFamily: "roboto, arial"}}>
                                        {t.firstName}
                                      </AvatarFallbackText>
                                    </Avatar>
                                  );
                   ...
                   <HStack style={{justifyContent: "space-between", alignItems: "center", flex: 1, borderWidth: 0}}>
                    <Text style={{fontFamily: "roboto, arial", fontWeight: "bold", color: "#ffffff"}}>Completed</Text>
                    <Divider style={{borderWidth: 2, flex: 1, marginLeft: 12, borderColor: "#1f1f1f"}}></Divider>
                  </HStack>


                  {/* Completed CONTENT HERE */}
                     <Text style={{color: "#ffffff", fontSize: 12, fontWeight: "bold", }}>I have no complete project yet.</Text>
