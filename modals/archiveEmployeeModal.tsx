...
export default function ArchiveEmployeeModal({
  ...
  const handleArchiveEmployee = async () => {
    ...
    try {
      ...
      console.log('Archived employee successfully!')
    } catch (error) {
      console.log('Archiving employee failed!', error)
    } finally {
      setIsSaving(false)
      onClose()
    }
    ...
    <Modal isOpen={visible} onClose={onClose} size="md">
      ...
      >
        ...
        <ModalFooter>
          ...
          <Button onPress={handleArchiveEmployee}>
            <ButtonText>
              {isSaving ? (
